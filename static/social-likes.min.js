...
!function(a) {
    ...
    var k = "social-likes"
      ...
      , p = {
        ...
        odnoklassniki: {
            counterUrl: (o ? "https://www" : "http://connect") + ".ok.ru/dk?st.cmd=extLike&ref={url}&uid={index}",
            counter: function(b, c) {
        ...
        plusone: {
            ...
            counter: function(b, c) {
                var d = p.plusone;
                return d._ ? void c.reject() : (window.services || (window.services = {}),
    ...
    c.prototype = {
        init: function() {
            ...
            this.options.counters ? this.timer = setTimeout(a.proxy(this.appear, this), this.options.wait) : this.appear()
        },
        ...
        updateCounter: function(a, b, c) {
            ...
            this.container.trigger("ready." + k, this.number))
        },
        appear: function() {
    ...
    d.prototype = {
        ...
        updateCounter: function(b) {
            "string" == typeof b && (b = b.replace(/\D/g, "")),
            b = parseInt(b, 10) || 0;
            var c = {
